<footer class="footer">
    ...
    <div class="footer-about">
        <div class="footer-about-container">
            <h2>About Poki</h2>
            <p> Poki is a web platform with more than 30 million users from all over the world. On it you’ll find
                thousands of hand-selected online games that you can play on your mobile, tablet or desktop.We work
